...
local_parameters = [{'name': 'camera_name1', 'default': 'camera', 'description': 'camera1 unique name'},
                    {'name': 'camera_name2', 'default': 'camera1', 'description': 'camera2 unique name'},
                    {'name': 'camera_namespace1', 'default': 'camera', 'description': 'camera1 namespace'},
                    {'name': 'camera_namespace2', 'default': 'camera1', 'description': 'camera2 namespace'},
