...
def generate_launch_description():
    ...
    leo_navigation2_dir = get_package_share_directory('leo_navigation2')
    ...
    start_navigation_rviz = LaunchConfiguration('start_navigation_rviz')   
    ...
    declare_start_navigation_rviz = DeclareLaunchArgument(
        'start_navigation_rviz', 
        default_value='true',
        choices=['true', 'false'],
        description='Whether to start_navigation_rviz')       
    # Specify the group
    base_bringup_group = GroupAction([
        IncludeLaunchDescription(
        ...
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(os.path.join(leo_navigation2_dir, 'launch',
    ...
    leo_delay_nav2_action = TimerAction(period=10.0, actions=[navigation_group])
    ...
    ld.add_action(base_bringup_group)
