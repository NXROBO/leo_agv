...
2.0.0 (2022-04-12)
------------------
* Porting to ros2 (`#12 <https://github.com/destogl/aubo_msgs/issues/12>`_)
* Document pin mapping in SetIO service (`#16 <https://github.com/destogl/aubo_msgs/issues/16>`_)
...
* Fix SetPayload srv separater invalid (`#10 <https://github.com/ros-industrial/aubo_msgs/issues/10>`_)
* Contributors: Chen Bainian, gavanderhoorn

1.3.2 (2020-10-12)
------------------
* Fix domain constants in ``Analog.msg`` (`#8 <https://github.com/ros-industrial/aubo_msgs/issues/8>`_)
* Contributors: Gaël Écorchard

1.3.1 (2020-06-24)
------------------
* Change ``payload`` field name to ``mass`` (`#5 <https://github.com/ros-industrial/aubo_msgs/issues/5>`_)
* Added ``center_of_gravity`` field to ``SetPayload`` service (`#2 <https://github.com/ros-industrial/aubo_msgs/issues/2>`_)
* Mark package as architecture independent (`#1 <https://github.com/ros-industrial/aubo_msgs/issues/1>`_)
