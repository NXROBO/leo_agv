...
def generate_launch_description():
    ...
    leo_hm_dir = get_package_share_directory('leo_hm_pi')
    ...
    hm_group = GroupAction([
        IncludeLaunchDescription(
          PythonLaunchDescriptionSource(os.path.join(leo_hm_dir, 'launch','hm_leo_nobase.launch.py')),
        ),
    ])
