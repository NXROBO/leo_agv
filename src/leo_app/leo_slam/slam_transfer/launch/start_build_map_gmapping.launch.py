...
def generate_launch_description():
    ...
    leo_slam_dir = get_package_share_directory('slam_gmapping')
    ...
    leo_delay_slam_action = TimerAction(period=3.0, actions=[slam_group])
    leo_delay_save_map_action = TimerAction(period=1.0, actions=[leo_save_map_node])
