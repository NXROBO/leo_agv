...
def generate_launch_description():
    ...
    leo_slam_dir = get_package_share_directory('leo_slam_toolbox')
    ...
    driver_bringup_group = GroupAction([
        ...
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(os.path.join(leo_slam_dir, 'launch',
    ...
    leo_save_map_node = launch_ros.actions.Node(
        package='leo_slam_transfer',
    ...
    leo_delay_slam_action = TimerAction(period=5.0, actions=[slam_group])
    leo_delay_save_map_action = TimerAction(period=5.0, actions=[leo_save_map_node])
    ...
    ld.add_action(leo_delay_slam_action)
