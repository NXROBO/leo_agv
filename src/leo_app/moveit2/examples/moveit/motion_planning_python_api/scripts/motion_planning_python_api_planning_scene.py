...
def add_collision_objects(planning_scene_monitor):
    ...
    with planning_scene_monitor.read_write() as scene:
        ...
        collision_object.header.frame_id = "aubo_base"
...
def main():
    ...
    aubo = MoveItPy(node_name="moveit_py_planning_scene")
    aubo_arm = aubo.get_planning_component("aubo_arm")
    planning_scene_monitor = aubo.get_planning_scene_monitor()
    ...
    aubo_arm.set_start_state(configuration_name="ready")
    aubo_arm.set_goal_state(configuration_name="extended")
    ...
    with planning_scene_monitor.read_only() as scene:
        ...
        original_joint_positions = robot_state.get_joint_group_positions("aubo_arm")
        ...
        robot_state.set_from_ik("aubo_arm", pose_goal, "wrist3_Link")
        robot_state.update()  # required to update transforms
        robot_collision_status = scene.is_state_colliding(
            robot_state=robot_state, joint_model_group_name="aubo_arm", verbose=True
        )
